...
const Contact = () => {
  return (
    <section className="contact section py-16 dark:bg-dark-container-color" id="contact">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="contact__container container flex-col items-start sm:flex gap-6 pb-4">
          {/* Teléfono */}
          <div className="contact__information flex items-center gap-5">
            <Phone className='text-first-color text-4xl'/>
            <div className='flex-col'>
              <h3 className="contact__title text-base font-medium text-title-color dark:text-dark-title-color mb-1">
                Teléfono
              </h3>
              <a 
